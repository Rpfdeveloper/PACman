...
class ChaseAmbushTest {

    @Test
    @Tag("sanity")
    @DisplayName("Sanity ChaseAmbush - Class definition")
    void checkClassSanity() {
        final Class<ChaseAmbush> ownClass = ChaseAmbush.class;
    ...
    public void checkMethodsSanity() {
        ...
        try {
            ...
            fail("[ERROR] ChaseAmbush's constructor is defined wrongly");
        }
